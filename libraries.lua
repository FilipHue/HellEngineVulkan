...
LibraryDirectories["YAML"] = "%{wks.location}/HellEngine/dependencies/YAML/lib"
...
Library["YAMLD"] = "%{LibraryDirectories.YAML}/yaml-cppd.lib"
Library["YAML"] = "%{LibraryDirectories.YAML}/yaml-cpp.lib"