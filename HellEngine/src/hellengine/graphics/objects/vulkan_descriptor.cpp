...
namespace hellengine
{
	...
	namespace graphics
	{
		...
		void VulkanDescriptorPool::Create(const VulkanInstance& instance, const VulkanDevice& device, const std::vector<VkDescriptorPoolSize>& pool_sizes, u32 max_sets)
		{
		...
		void hellengine::graphics::VulkanDescriptorSet::Create(const VulkanInstance& instance, const VulkanDevice& device, VkDescriptorSetLayout layout, VulkanDescriptorPoolGrowable& pool, u32 set)
		{
			m_set = set;
