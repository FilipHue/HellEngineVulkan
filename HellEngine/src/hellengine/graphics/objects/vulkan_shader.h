...
namespace hellengine
{
	namespace graphics
	{
		...
		public:
			...
			void Create(const VulkanInstance& instance, const VulkanDevice& device, resources::File& file, ShaderType type);
		...
		static std::vector<char> CompileSource(resources::File& file, ShaderType type);
