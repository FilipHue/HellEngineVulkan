...
namespace hellengine
{
	...
	namespace graphics
	{
		...
		public:
			...
			HE_API void SetAspect(f32 width, f32 height) { m_aspect_ratio = width / height; RecalculateProjectionMatrix(); }
			HE_API void SetPosition(glm::vec3 position) { m_position = position; RecalculateViewMatrix(); }
