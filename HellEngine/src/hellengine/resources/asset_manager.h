...
namespace hellengine
{
	...
	namespace resources
	{
		...
		public:
			...
			HE_API static std::vector<File> GetLoadedFiles() { return s_loaded_files; }
		...
		private:
			static Mesh* ProcessNode(aiNode* node, const aiScene* scene, const glm::mat4& parent_transform, Mesh* parent_mesh, const File& file);
			static Mesh* ProcessMesh(aiMesh* mesh, const aiScene* scene, const glm::mat4& transform, Mesh* parent_mesh, const File& file);
			...
			INLINE static std::vector<File> s_loaded_files = { };
			INLINE static std::vector<Mesh*> s_loaded_root_meshes = { };
			INLINE static std::vector<Mesh*> s_all_loaded_meshes = { };
